...
from src.contexts.shared.domain.aggregates.aggregate_root import AggregateRoot
...
class Notification(AggregateRoot):
    ...
    def record_created_domain_event(self) -> None:
        CREATED_DOMAIN_EVENTS = {
            "SALES": NotificationSlackCreatedDomainEvent,
            "PRICING": NotificationEmailCreatedDomainEvent,
        }
